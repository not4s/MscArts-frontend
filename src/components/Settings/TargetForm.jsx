...
import {Button, Form, Select, Input, Progress, Spin, Modal} from "antd";
...
const TargetForm = () => {
    ...
    api.postTarget(values)
        .then(res => {
          ...
          api.getTargets()
              ...
              .catch(err => {console.log(err); setLoaded(true)})
        })
  ...
  return (
    <div>
      ...
      <Button onClick={()=>setShowModal(true)}>Add new target</Button>
      <div>
        <>
          {
            !loaded ?
